...
public class AES {
	...
	public byte[] encrypt(byte[] plain) {
		...
		if (traceLevel > 2)
			traceInfo += "n  R0 (Key = " + Util.toHEX1(Ker) + ")ntAK = "
					+ Util.toHEX1(a);
		else if (traceLevel > 1)
			traceInfo += "n  R0 (Key = " + Util.toHEX1(Ker) + ")t = "
					+ Util.toHEX1(a);
		...
		if (traceLevel > 1)
			traceInfo += "n  R" + numRounds + " (Key = " + Util.toHEX1(Ker)
					+ ")t";
	...
	public byte[] decrypt(byte[] cipher) {
		...
		if (traceLevel > 2)
			traceInfo += "n  R0 (Key = " + Util.toHEX1(Kdr) + ")nt AK = "
					+ Util.toHEX1(a);
		else if (traceLevel > 1)
			traceInfo += "n  R0 (Key = " + Util.toHEX1(Kdr) + ")t = "
					+ Util.toHEX1(a);
		...
		if (traceLevel > 1)
			traceInfo += "n  R" + numRounds + " (Key = " + Util.toHEX1(Kdr)
					+ ")t";
	 ...
	 *            key to test in hex
	 * @param hplain
	 *            plaintext to test in hex
	 * @param hcipher
	 *            ciphertext to test in hex
	 * @param lev
	 *            trace level to use
	 */
	public static void self_test(String hkey, String hplain, String hcipher,
			int lev) {
	...
	public String Decrypt(String data) {
		String result = _cryptAll(data, 2).trim();
	...
	public static void main(String[] args) {
		...
		String data = "hello world dfgsdfgsdfgsdfg     9nkijero8jdoifjg8sroisdfg  123456";
		AES aes = new AES();
		aes.setKey(cryptKey);
		String cipher = aes.Encrypt(data);
		System.out.println("Cipher :" + cipher);
		String rlt = aes.Decrypt(cipher);
		System.out.println("Result :" + rlt);

		BigInteger p = new BigInteger(
				"FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF000000000000000000000001", 16);
		BigInteger privateKey = BigInteger.probablePrime(128,
				new SecureRandom());

		System.out.println(privateKey.toString(16));
		System.out
				.println(static_stringToByteArray(privateKey.toString(16)).length);
